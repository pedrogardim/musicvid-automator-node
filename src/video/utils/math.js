...
export const transform = function (spectrum) {
  let subArr = spectrum
    .slice(Config.startBin, Config.startBin + Config.keepBins)
    .map((n) => n * 256);
  // );
...
export const multiplier = function (spectrum) {
  let sum = 0;
  ...
  // let intermediate = sum / Config.keepBins;
  let transformer = 1.2;
  return (
    (1 / (transformer - 1)) *
